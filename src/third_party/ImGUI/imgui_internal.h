...
// TODO made a overloaded function passing char data type
IMGUI_API const char*ImStrbolW(const char* buf_mid_line, const char* buf_begin);   // Find beginning-of-line (ImWchar string)
...
#define IMSTB_TEXTEDIT_CHARTYPE           char      // TODO it was ImWchar causing errors so move it to char
...
struct IMGUI_API ImGuiInputTextState
{
    ...
    // TODO function was missing so added this 
